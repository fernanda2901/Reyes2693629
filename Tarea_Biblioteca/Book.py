...
class Book (Library):
    def _init_(self, Titulo:str , Autor:str , ISBN:str , Publicacion:str , Name:str):
        self.__titulo = [Titulo]
        self.__autor =  [Autor]
        self.__titulo_autor = {Titulo : Autor}
        self.__estado = "Disponible"
        self.informacion = {Titulo : [Autor, ISBN, Publicacion , self._estado] }
        self._titulo_estado = {Titulo:self._estado}
        self.__titulo_comentario = {}
        self._obj_titulo = {Name : Titulo }
        Library._init_(self , ISBN , Titulo)
    ...
    def setISBN (self, titulo, isbn):
        if titulo in self.__titulo:
            ...
            self.informacion.update({titulo : [self._autor[value_autor_index] , isbn , publicacion , estado]})
